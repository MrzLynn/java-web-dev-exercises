...
public class Alice {
    public static void main(String[] args) {
        ...
        System.out.println("The first sentence of Alice contains your search term: " + result);
        ...
        String modifiedFirstSentence = firstSentence.replace(searchTerm, replacement: "");
